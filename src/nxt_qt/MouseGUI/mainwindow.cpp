...
namespace minotaur {
	...
	void MainWindow::updateMouseMovement(
				     ...
				     double x_disp2, double y_disp2)
	{
	  ...
	  lineEdit_mouse_x->setText(QString("%1").arg(x_disp1,0,'f',2));
	  lineEdit_mouse_y->setText(QString("%1").arg(y_disp1,0,'f',2));
	  lineEdit_speed_x->setText(QString("%1").arg(x_speed1,0,'f',2));
	  lineEdit_speed_y->setText(QString("%1").arg(y_speed1,0,'f',2));
	  globalx1 = x_disp1;
	  globaly1 = y_disp1;
	  
	  lineEdit_mouse_x_2->setText(QString("%1").arg(x_disp2,0,'f',2));
	  lineEdit_mouse_y_2->setText(QString("%1").arg(y_disp2,0,'f',2));
	  lineEdit_speed_x_2->setText(QString("%1").arg(x_speed2,0,'f',2));
	  lineEdit_speed_y_2->setText(QString("%1").arg(y_speed2,0,'f',2));
	  globalx2 = x_disp2;
	  globaly2 = y_disp2;
